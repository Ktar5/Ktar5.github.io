...
project: true
img: https://i.imgur.com/placeholder.png
tag:
  - Hytale
  - UI Engineering
  - C++
...
_[Screenshot: Hytale inventory screen]_
...
_[Screenshot: Node editor in use]_

---

## See It in Action

_[Embed: public Hytale footage showing tools UI, inventory, main menu — link TBD]_

The work I'm most proud of isn't any single screen, it's the dozens of panels of UI working together. Quality UI is UI that's maintainable, that other engineers can extend, that performs under real game conditions, and that players actually use without thinking about it.
